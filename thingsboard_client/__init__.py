...
from thingsboard_client.api.billing_controller_api import BillingControllerApi
...
from thingsboard_client.api.device_api_controller_api import DeviceApiControllerApi
